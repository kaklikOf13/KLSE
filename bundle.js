...
export { loadLanguage as loadLanguage };
class Definitions {
    value;
    constructor(){
        this.value = {};
...
class LocalizatorDefs {
    ...
    _get(val, vv, err) {
        if (val.length == 1) {
            ...
            return this._get(val.slice(1, val.length), vv[val[0]], err);
        }
...
export { LocalizatorDefs as LocalizatorDefs };
